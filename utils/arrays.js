...
export const contains = (s) => (arr) => arr.some(a => JSON.stringify(a) === JSON.stringify(s));
...
export const range = (min, maxExclusive) => Array.from(new Array(maxExclusive - min).keys());